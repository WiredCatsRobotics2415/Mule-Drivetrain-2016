...
public class RobotMap {
    ...
    /*
    public static final int ACCUMULATE_SOLENOID_1 = 0;
    public static final int ACCUMULATE_SOLENOID_2 = 0;
    public static final int ACCUMULATE_SOLENOID_3 = 0;
    public static final int ACCUMULATE_SOLENOID_4 = 0;
    
    public static final int FIRE_SOLENOID_1 = 0;
    public static final int FIRE_SOLENOID_2 = 1;
    public static final int FIRE_SOLENOID_3 = 2;
    public static final int FIRE_SOLENOID_4 = 3;
