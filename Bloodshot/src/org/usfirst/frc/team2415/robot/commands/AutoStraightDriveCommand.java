...
public class AutoStraightDriveCommand extends Command {
	...
	public AutoStraightDriveCommand(float desiredDistance) {
        ...
        this.distancePID = Robot.driveSubsystem.rotationalPID;
    ...
    protected void initialize() {
    	...
    	if(Robot.driveSubsystem.debugAutoStraightDriveCommand){
	    	try {
    ...
    protected void execute() {
    	double speed = distancePID.getPIDOutput(Robot.driveSubsystem.getLeftEncoder(), desiredDistance);
    	//double rotation = yawPID.getPIDAngleOutput(Robot.driveSubsystem.getWrappedYaw(0), 0, Robot.driveSubsystem.getWrappedYaw(0));
